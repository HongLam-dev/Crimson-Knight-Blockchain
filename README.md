# Crimson Knight: 2D Multiplayer RPG with Blockchain Integration
## Overview
This project is a prototype 2D multiplayer RPG built with Unity.  
It explores the integration of blockchain into game systems while keeping gameplay as the core experience.
...
- Character system with skills and equipment
- Blockchain integration:
  - Wallet connection
  - NFT item minting (withdraw from game)
  - Marketplace for trading
- Blockchain is optional and does not affect core gameplay
## Technical Details
- Built with Unity (C#)
